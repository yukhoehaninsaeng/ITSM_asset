          ...
          <div className="modal-bd" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div className="grid-2">
              <div className="form-group">
                <label className="form-label">자산번호 *</label>
                <input className="form-control" required value={form.asset_number} onChange={e => set('asset_number', e.target.value)} placeholder="AST-0001" disabled={isEdit} />
              </div>
              <div className="form-group">
                <label className="form-label">자산명 *</label>
                <input className="form-control" required value={form.name} onChange={e => set('name', e.target.value)} placeholder="Dell XPS 15" />
              </div>
            </div>
            <div className="grid-2">
              <div className="form-group">
            ...
            <div className="grid-2">
              <div className="form-group">
                ...
                <input className="form-control" value={form.manufacturer} onChange={e => set('manufacturer', e.target.value)} placeholder="Dell" />
              </div>
              <div className="form-group">
                <label className="form-label">모델</label>
                <input className="form-control" value={form.model} onChange={e => set('model', e.target.value)} placeholder="XPS 15 9530" />
              </div>
            </div>
            <div className="grid-2">
              <div className="form-group">
                <label className="form-label">시리얼 번호</label>
                <input className="form-control" value={form.serial_number} onChange={e => set('serial_number', e.target.value)} placeholder="SN-XXXX" />
              </div>
              <div className="form-group">
                <label className="form-label">담당자</label>
                <select className="form-control" value={form.assigned_to} onChange={e => set('assigned_to', e.target.value)}>
                  <option value="">미배정</option>
                  {users.map(u => <option key={u.id} value={u.id}>{u.full_name || u.username} ({u.department || '—'})</option>)}
                </select>
              </div>
            </div>
            <div className="grid-2">
              <div className="form-group">
                ...
                <input className="form-control" value={form.location} onChange={e => set('location', e.target.value)} placeholder="서울 본사 3층" />
              </div>
              <div className="form-group">
                <label className="form-label">부서</label>
                <input className="form-control" value={form.department} onChange={e => set('department', e.target.value)} placeholder="개발팀" />
              </div>
            </div>
            <div className="grid-2">
              <div className="form-group">
              ...
              <div className="form-group">
                <label className="form-label">보증 만료일</label>
                <input type="date" className="form-control" value={form.warranty_expiry} onChange={e => set('warranty_expiry', e.target.value)} />
              </div>
            </div>
            <div className="form-group">
              <label className="form-label">설명</label>
              <textarea className="form-control" value={form.description} onChange={e => set('description', e.target.value)} placeholder="자산에 대한 설명..." />
            </div>
            <div className="form-group">
              <label className="form-label">비고</label>
              <textarea className="form-control" style={{ minHeight: 60 }} value={form.notes} onChange={e => set('notes', e.target.value)} placeholder="추가 메모..." />
            </div>
          </div>
